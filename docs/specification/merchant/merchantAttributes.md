# Merchant Attributes
* **Description**: List of fields grouped under logical **Domains** and stored as key-value(s) pair as attribute name and values. Example of a **Domain**:
  ...
  - See all available [list of Domains](#list-of-domains)
